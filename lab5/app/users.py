...
def index():
    ...
    current_user_role = user_repository.get_by_id(current_user_id).role if current_user.is_authenticated else None
    return render_template('users/index.html', users=user_repository.get_all(), current_user_role=current_user_role)
...
def new():
    ...
    return render_template('users/new.html', user_data=user_data, roles=role_repository.get_all(), errors=errors, current_user_role=current_user_role)
...
def edit(user_id):
    ...
    return render_template('users/edit.html', user_data=user, roles=role_repository.get_all(), errors=errors, current_user_role=current_user_role)
